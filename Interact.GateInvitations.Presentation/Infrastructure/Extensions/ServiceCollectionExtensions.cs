    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddGateInvitationAuthorization(this IServiceCollection services)
        {
            services.AddAuthorization(opts =>
            {
                ...
                opts.AddPolicy(GateAppConfig.ActivatedCustomerPolicy, policy => {
                    policy.RequireAssertion(context => {
                        var customerService = AppServiceProvider.GetService<ICustomerService>();
                        return customerService.IsActivated(context.User.GetLoggedInUserId<Guid>());
                    });
                });
            });
            return services;
